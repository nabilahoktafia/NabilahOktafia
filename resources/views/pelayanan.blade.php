			...
			<table class="data-table table stripe hover nowrap">
				<thead>
					<tr>
						...
						<th>Pelayanan Kesehatan Ibu Hamil</th>
						<th>Pelayanan Kesehatan Ibu Bersalin</th>
						<th>Pelayanan Kesehatan Bayi Baru Lahir</th>
						<th>Pelayanan Kesehatan Balita</th>
						<th>Pelayanan Kesehatan Pada Usia Pendidikan Dasar</th>
				...
				<tbody>
					@foreach ($spm as $item)
							<tr>
								...
								<td>{{$item->pelayanan_kesehatan_ibu_hamil}}</td>
								<td>{{$item->pelayanan_kesehatan_ibu_bersalin}}</td>
								<td>{{$item->pelayanan_kesehatan_Bayi_baru_lahir}}</td>
								<td>{{$item->pelayanan_kesehatan_balita}}</td>
								<td>{{$item->pelayanan_kesehatan_pada_usia_pendidikan_dasar}}</td>
								<td>
									<div class="dropdown">
										{{-- <a class="dropdown-item" href="form"><i class="dw dw-edit2"></i> Edit</a>
										<a class="dropdown-item" href="#"><i class="dw dw-delete-3"></i> Delete</a> --}}
										<a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="#" role="button" data-toggle="dropdown">
											<i class="dw dw-more"></i>
										</a>
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											{{-- <a class="dropdown-item" href="laporan"><i class="dw dw-eye"></i> View</a> --}}
											<a class="dropdown-item" href="edit"><i class="dw dw-edit2"></i> Edit</a>
											<a class="dropdown-item" href="/hapus/{{$item->id}}"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
